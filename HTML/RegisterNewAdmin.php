    ...
    <div class="container-fluid" style="margin-top: 40px">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h5 class="m-0 font-weight-bold" id="exampleModalLabel" style="color: #a10202">Add Admin Data</h5>
            ...
            <form action="code.php" method="post">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="Fname" class="form-control" placeholder="Enter UserName" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Last Name</label>
                        <input type="text" name="Lname" class="form-control" placeholder="Enter UserName" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Personal ID</label>
                        <input type="number" name="UserID" class="form-control" placeholder="Enter ID" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Email</label>
