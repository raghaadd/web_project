        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body" >
                ...
                if(isset($_POST['edit_btn'])){
                    $id=$_POST['edit_id'];
                    $query="SELECT personal_ID,Apassword FROM admin WHERE personal_ID='$id'";
                    ...
                    foreach($query_run as $row){
                        ...
                        <form action="code.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="edit_id" autocomplete="off" value="<?php echo $row['personal_ID']; ?>" class="form-control" placeholder="Update User ID">
                            </div>
                            <div class="form-group">
                                ...
                                $connection=mysqli_connect("localhost","root","","cinema");
                                $idc=$row['personal_ID'];
                                $query="SELECT personal_ID,Email_Address FROM person WHERE personal_ID='$idc' ";
                                $query_num1=mysqli_query($connection,$query);
                                $row12=mysqli_fetch_assoc($query_num1);
                                echo $row12['Email_Address'];
                                ?>"  class="form-control" placeholder="Update User Email">
                            </div>
                            <div class="form-group">
                                <label>Password</label>
                                <input type="password" name="edit_password" autocomplete="off" value="<?php echo $row['Apassword']; ?>"  class="form-control" placeholder="Update User Password">
                            </div>
