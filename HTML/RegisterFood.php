...
<div  style="margin-left:13%;padding:1px 16px;margin-top: 30px">
    <div class="searchh" style="width: 500px ">
        ...
        <form action="RegisterFood.php" method="post" class=" search" style="margin:auto;max-width:300px;border-color: grey ">
            <input type="text" name="valuetosearch" placeholder="Search" autocomplete="off">
            <button type="submit" style="background-color: #a10202" name="searchfood"><i class="fa fa-search" style="background-color: #a10202"></i></button>
        </form>
        <!--        </form>-->
    </div>
</div>
    ...
    <div class="container-fluid" style="margin-top: 40px">
        <div class="card shadow mb-4">
            <div class="card-header py-3" >
                <form method="post" action="RegisterNewFood.php">
                    <h6 class="m-0 font-weight-bold " style="color: #a10202;">Snack
            ...
            <div class="card-body" >
                ...
                <div class="table-responsive" >
                    ...
                    if(isset($_POST['searchfood']))
                    {
                        ...
                        $query = "SELECT * FROM food WHERE foodName LIKE '%".$valueToSearch."%'";
                        $query_run = mysqli_query($connection, $query);
                    }
                    ?>
                        ...
                        if(mysqli_num_rows($query_run)>0){
                            while ($row=mysqli_fetch_assoc($query_run)){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="foodRegister_edit.php" method="post">
                                            <input type="hidden" name="edit_id" value="<?php echo $row['foodName']; ?>">
                                            <button type="submit" name="edit_btn" class="btn btn-success">EDIT</button>
                                        </form>
                                    </td>
                                    <td>
                                        <form action="foodCode.php" method="post">
                                            <input type="hidden" name="delete_id" value="<?php echo $row['foodName']; ?>">
