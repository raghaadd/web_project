    ...
    <div class="container-fluid" style="margin-top: 40px">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h5 class="m-0 font-weight-bold" id="exampleModalLabel" style="color: #a10202">Add Movie</h5>
            ...
            <form action="movieCode.php" method="post">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="moviename" class="form-control" placeholder="Enter UserName" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Show Day</label>
                        <input type="text" name="showday" class="form-control" placeholder="Enter Movie Show Day" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Show Date</label>
                        <input type="date" name="showdate" class="form-control" placeholder="Enter Movie Show Date" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Hall Number</label>
                        <input type="number" name="hallnumber" class="form-control" placeholder="Enter Movie Hall Number" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Movie Rate</label>
                        <input type="text" name="movierate" class="form-control" placeholder="Enter Movie Rate" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Movie Description</label>
                        <input type="text" name="moviediscription" class="form-control" placeholder="Enter Movie Description" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Movie Picture</label>
                        <input type="file" name="moviepicture" class="form-control" placeholder="Enter Movie Picture" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Movie Trailer</label>
                        <input type="file" name="movietrailer" class="form-control" placeholder="Enter Movie Trailer" autocomplete="off">
                    </div>
