    ...
    <div class="container-fluid" style="margin-top: 40px">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold " style="color: #a10202;">Edit Snack Information</h6>
            </div>
            <div class="card-body" >
                ...
                if(isset($_POST['edit_btn'])){
                    $foodName=$_POST['edit_id'];
                    $query="SELECT foodName,price,description,photo FROM food WHERE foodName='$foodName'";
                    ...
                    foreach($query_run as $row){
                        ...
                        <form action="foodCode.php" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="edit_foodname" value="<?php echo $row['foodName']; ?>" class="form-control" autocomplete="off" placeholder="Update Food Name">
                            </div>

                            <div class="form-group">
                                <label>Snack Price</label>
                                <input type="number" name="edit_foodprice" value="<?php echo $row['price']; ?>" class="form-control" autocomplete="off" placeholder="Update Food Price">
                            </div>
                            <div class="form-group">
                                <label>Snack Description</label>
                                <input type="text" name="edit_fooddiscription" value="<?php echo $row['description']; ?>" class="form-control" autocomplete="off" placeholder="Update Food Description">
                            </div>
                            <div class="form-group">
                                <label>Snack Picture</label>
                                <input type="file" name="edit_foodphoto" value="<?php echo $row['photo']; ?>" class="form-control" autocomplete="off" placeholder="Update Food Picture">
                            </div>
